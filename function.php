...
define("_TAD_LINK_PIC_URL",XOOPS_URL.'/uploads/tad_link');
define("_TAD_LINK_PIC_PATH",XOOPS_ROOT_PATH.'/uploads/tad_link');
define("_TAD_LINK_THUMB_PIC_URL",XOOPS_URL.'/uploads/tad_link/thumbs');
define("_TAD_LINK_THUMB_PIC_PATH",XOOPS_ROOT_PATH.'/uploads/tad_link/thumbs');
...
function get_show_pic($link_sn,$mode='thumb'){
  ...
  if($mode=='thumb'){
    $pic=_TAD_LINK_THUMB_PIC_URL."/{$link_sn}.jpg";
    $pic_path=_TAD_LINK_THUMB_PIC_PATH."/{$link_sn}.jpg";
  }else{
    $pic=_TAD_LINK_PIC_URL."/{$link_sn}.jpg";
    $pic_path=_TAD_LINK_PIC_PATH."/{$link_sn}.jpg";
  }
